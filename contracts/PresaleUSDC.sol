...
contract PresaleUSDC is Ownable, ReentrancyGuard {
    ...
    uint256 public end;
    address public depositToken = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //USDC 6 DECIMALS

    uint256 public presaleMin = 2000 * 10**6; //2K
    uint256 public presaleMax = 250000 * 10**6; //250K

    uint256 public hardCapAmount = 250000 * 10**6; //250K

    uint256 public poolRate = 3100; //31 Tokens per $1 USDC
